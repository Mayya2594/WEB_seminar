...
$experience = [
    [   
        'name' => 'Оператор',
        'description' => 'Консультирование клиентов по вопросам банковских продуктов',
        'start' => 'sept 2016',
        'end' => 'apr 2017',
    ],
    [
        'name' => 'Экономист',
        'description' => 'Контроль расходов на строительство',
        'start' => 'apr 2017',
        'end' => 'june 2017',
    ],
    [
        'name' => 'Кассир',
        'description' => 'Прием платы за оказанные услуги',
        'start' => 'oct 2017',
        'end' => 'feb 2019',
    ],
    [
        'name' => 'Экономист',
        'description' => 'Контроль соблюдения кассовой дисциплины',
        'start' => 'mar 2019',
        'end' => 'dec 2022',    
    ],
];
          ...
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            ?>
                <div class="w3-container">
                    ...
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['start'] ?> - <span
                        class="w3-tag w3-teal w3-round"><?php echo $experience[$i]['end'] ?></span></h6>
